...
(function withAngular(angular) {
  ...
  var directiveName = 'socialshare'
    ...
    , socialshareProviderNames = ['facebook', 'facebook-messenger', 'sms', 'twitter', 'line', 'linkedin', 'google', 'pinterest', 'tumblr', 'reddit', 'stumbleupon', 'buffer', 'digg', 'delicious', 'vk', 'pocket', 'wordpress', 'flipboard', 'xing', 'hackernews', 'evernote', 'whatsapp', 'telegram', 'viber', 'skype', 'email', 'ok']
    ...
    , manageLineShare = function manageLineShare($window, attrs, element) {

    var urlString = '//line.me/R/msg/text/?';

      //default to the current page if a URL isn't specified
      var linkToShare = attrs.socialshareUrl || $window.location.href;

      var link = urlString + encodeURIComponent(linkToShare).replace(/\+/g, '%20');
